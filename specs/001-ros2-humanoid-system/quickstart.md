# Quickstart: ROS 2 Humanoid System Documentation
...
docs/
├── docs/
│   ├── ros2-humanoid-system/          # Main module directory
│   │   ├── introduction-to-ros2.md    # Chapter 1
│   │   ├── communication-model.md     # Chapter 2
│   │   └── robot-structure-urdf.md    # Chapter 3
│   └── ...
...
1. Create a new `.md` file in the `docs/docs/ros2-humanoid-system/` directory
